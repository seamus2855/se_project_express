...
const validateURL = (value, helpers) => {
  ...
  return validator.isURL(value, { require_protocol: true }) ? value : helpers.message("Must be a valid URL");
};
...
// ==========================================
// 3. PATCH /users/me — Update Profile Schema (FIXED)
// ==========================================
// Removed .required() so partial updates don't cause 400 validation crashes
...
// ==========================================
// 5. URL Parameter Schema — Validates MongoDB ObjectIds (:id)
// ==========================================
